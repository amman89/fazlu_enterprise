			...
			<div class="container">	
              <div class="row">
                 <div id="sidebar" class="4u">
                   <section>
                   <header>
					  <h2><b>User/Dealer Registration</b></h2>
					</header>	
                    <div class="row">
					<section class="6u">					
				<form method="post" action="user_insert.php">
				<label><font color = "white"><b>User Name</b></font> </label>   : <input type="text" name="User_Name" placeholder="Enter User Name" /><br />
				<label><font color = "white"><b>User Road </b></font></label>: <input type="text" name="User_Road" placeholder="Enter User Road" /><br />
