...
if ($_SERVER["REQUEST_METHOD"] == "POST") {//Check it is comming from a form
    ...
    $u_address = filter_var($_POST["User_Road"], FILTER_SANITIZE_STRING);
   ...
   // }   
    ...
    $statement = $mysqli->prepare("INSERT INTO dealers (USER_NAME, USER_ROAD) VALUES(?, ?)"); //prepare sql insert query
