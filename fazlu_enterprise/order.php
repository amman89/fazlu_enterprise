		...
		<div id="main">
			<div class="container">	
              <div class="row">
				...
				<label><font color = "white"><b>Order Number</b></font> </label>   : <input type="int" name="Order_Number" placeholder="Enter Order Number" /><br />
				<label><font color = "white"><b>Rate</b></font> </label>   : <input type="int" name="Order_Rate" placeholder="Enter Rate of the Product ( Single Quantity) " /><br />
				<label><font color = "white"><b>Quantity</b></font> </label>   : <input type="int" name="Order_Quantity" placeholder="Enter Quantity of the Product" /><br />
				<label><font color = "white"><b>Date</b></font> </label>   : <input type="date" name="Order_date" placeholder="Enter Date" /><br />
