              ...
              <div class="row">
                 <div id="sidebar" class="4u">
                   ...
                   <header>
					...
					<section class="6u">					
				<form method="post" action="company_insert.php">
				<label><font color = "white"><b>Company Name</b></font> </label>   : <input type="text" name="Company_Name" placeholder="Enter Company Name" /><br />
				<label><font color = "white"><b>Company Address </b></font></label>: <input type="text" name="Company_Address" placeholder="Enter Company Address" /><br />
				<label><font color = "white"><b>Company Contact </b></font></label>: <input type="text" name="Company_Contact" placeholder="Enter Contact Number" /><br />
