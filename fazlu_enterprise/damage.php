...
<form method="post" action="damage_insert.php">
<body>
		...
		<div id="main">
			<div class="container">	
              <div class="row">
				...
				<label><font color = "white"><b>Order Number</b></font> </label>   : <input type="int" name="Damage_Number" placeholder="Enter Damage Order Number" /><br />
				<label><font color = "white"><b>Rate</b></font> </label>   : <input type="int" name="Damage_Rate" placeholder="Enter Damage Rate of the Product ( Single Quantity) " /><br />
				<label><font color = "white"><b>Quantity</b></font> </label>   : <input type="int" name="Damage_Quantity" placeholder="Enter Damage Quantity of the Product" /><br />
				<label><font color = "white"><b>Date</b></font> </label>   : <input type="date" name="Damage_date" placeholder="Enter Date" /><br />
